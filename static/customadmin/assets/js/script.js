...
$('#layoutDirection .nav-link').on('click', function(e){
  ...
  window.location.href = newLoc;
    ...
    const year_categories = {{ transactions_by_year|json_script:"year_categories" }};
    const year_data = {{ transactions_by_year|json_script:"year_data" }};

    const month_categories = {{ transactions_by_month|json_script:"month_categories" }};
    const month_data = {{ transactions_by_month|json_script:"month_data" }};

    const week_categories = {{ transactions_by_week|json_script:"week_categories" }};
    const week_data = {{ transactions_by_week|json_script:"week_data" }};
